 ...
 */
final class Version20220228091843 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cible (id INT AUTO_INCREMENT NOT NULL, nationality_id INT NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, date_naissance DATE NOT NULL, name_code VARCHAR(255) NOT NULL, INDEX IDX_E15DEC3B1C9DA55 (nationality_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
