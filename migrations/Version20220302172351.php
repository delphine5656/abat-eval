 ...
 */
final class Version20220302172351 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE mission_test (mission_id INT NOT NULL, test_id INT NOT NULL, INDEX IDX_F13DD203BE6CAE90 (mission_id), INDEX IDX_F13DD2031E5D0459 (test_id), PRIMARY KEY(mission_id, test_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
